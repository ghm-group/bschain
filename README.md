# SupplyChain Logistics Traceability Solution based on Blockchain Technology

## 1. Introduction
The project, "Blockchain-based Logistics Traceability," aims to revolutionize supply chain management using 
