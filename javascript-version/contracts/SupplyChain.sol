...
contract SupplyChain {
    ...
    // Mapping to store transaction timestamps
    mapping(uint256 => uint256) public supplyTimestamps;
    ...
    function RMSsupply(uint256 _medicineID) public {
        ...
        supplyTimestamps[_medicineID] = block.timestamp;
    }
    ...
    // Mapping to store transaction timestamps
    mapping(uint256 => uint256) public manufacturingTimestamps;
    ...
    function Manufacturing(uint256 _medicineID) public {
        ...
        manufacturingTimestamps[_medicineID] = block.timestamp;
    }
    ...
    // Mapping to store transaction timestamps
    mapping(uint256 => uint256) public distributeTimestamps;
    ...
    function Distribute(uint256 _medicineID) public {
        ...
        distributeTimestamps[_medicineID] = block.timestamp;
    }
    ...
    // Mapping to store transaction timestamps
    mapping(uint256 => uint256) public retailTimestamps;
    ...
    function Retail(uint256 _medicineID) public {
        ...
        retailTimestamps[_medicineID] = block.timestamp;
    }
    ...
    // Mapping to store transaction timestamps
    mapping(uint256 => uint256) public medicineTimestamps;
        ...
        onlyByOwner()
    {
        ...
        medicineTimestamps[medicineCtr] = block.timestamp;
    }
}
